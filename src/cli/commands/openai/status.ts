...
import { loadOpenAIConfig, loadOpenAIModels } from "../../../config/openai.js";
import { line, width } from "../../../utils/cliTypes.js";

export async function runOpenAIStatus(): Promise<void> {
  const config = loadOpenAIConfig();
  const models = loadOpenAIModels();

  console.log();
  console.log(chalk.dim("┌  ") + chalk.bold.green("OpenOKAPI OpenAI Status"));
